...
for f in range(0, 23):
    def generateConstraints(lines):
        ...
        # VARIATION 2 ADD-ON: Specifying 1 must eat food:
        #   EXAMPLE: y_1_6 = 1 (Szechuan Beef with Jasmine Rice must be eaten)

        for t in range(0,3):
            constraintValues += "+y_" + str(t) + "_" + str(f) + " "
        constraintValues += "= 1; \n"
